...
Все артефакты архитектурной функции, да и не только, должны лежать рядом, в одном архитектурном репозитории. Такой подход позволяет приземлиться от процесса до машины, на которой он крутится. И Sparx это в теории позволяет.
...
Это был первый набросок, потом я попросил ИИ пофантезировать, как может выглядеть декомпозиция для этого процесса. И вот что он мне выдал:
...
Получилось нечитаемо и слишком упоролся в декомпозицию, но меня расмешнило.
...
Так у меня конечно же не получилось, и я упоролся. Сделал первую диаграмму руками, а дальше подтянул агента и он сделал всё по моим гайдлайнам.

Начало GET/v1/riddle:
